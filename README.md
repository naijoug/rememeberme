...
A browser extension that helps you track and manage unfamiliar English words to improve your language learning efficiency.
...
3. Select the `manifest.json` file from the `.output/firefox-mv2` directory
